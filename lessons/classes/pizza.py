...
"""Think of a class definiton as a "roadmap" for objects that belong to the class. 
You are defining the underlying structure every instance of this class wil have"""


class Pizza:

    # attributes
    # Think of these as the variables each instance
    # of my class will have
    # <name> : <type>
    size: str
    toppings: int
    gluten_free: bool
